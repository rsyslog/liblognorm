...
main(void)
{
	...
	/*
	 * An empty word is refused. A message that begins with a space is not
	 * covered here: the VM trims leading whitespace before it starts, which
	 * the standard parser does not, and that difference is its own defect
	 * rather than a property of this parser.
	 */
