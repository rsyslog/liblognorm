...
execute 'CEF:0|a|b|c|d|e|f|field1=value1 field2=value2'
assert_output_json_eq '{ "f": { "DeviceVendor": "a", "DeviceProduct": "b", "DeviceVersion": "c", "SignatureID": "d", "Name": "e", "Severity": "f", "Extensions": { "field1": "value1", "field2": "value2" } } }'
